                        ...
                        <div class="nk-header-wrap">
                            ...
                            <div class="nk-header-brand d-xl-none">
                                <a href="{{ route('admin.home') }}" class="logo-link">
                                    <img class="logo-light logo-img" src="{{asset('public/admin/assets/images/logo2.png')}}" srcset="{{asset('public/admin/assets/images/logo2.png 2x')}}" alt="logo">
                                    <img class="logo-dark logo-img" src="{{asset('public/admin/assets/images/logo2.png')}}" srcset="{{asset('public/admin/assets/images/logo2.png 2x')}}" alt="logo-dark">
                                </a>
                            </div><!-- .nk-header-brand -->
                                            ...
                                            <div class="dropdown-body">
                                                <ul class="chat-list">
                                                    ...
                                                    <li class="chat-item">
                                                        <a class="chat-link" href="html/apps-chats.html">
                                                            <div class="chat-media user-avatar">
                                                                <img src="{{asset('public/admin/assets/images/avatar/b-sm.jpg')}}" alt="">
                                                            </div>
                                                            <div class="chat-info">
                                                                <div class="chat-from">
                                                        ...
                                                        <a class="chat-link" href="html/apps-chats.html">
                                                            <div class="chat-media user-avatar user-avatar-multiple">
                                                                <div class="user-avatar">
                                                                    <img src="{{asset('public/admin/assets/images/avatar/c-sm.jpg')}}" alt="">
                                                                </div>
                                                                <div class="user-avatar">
                                                                    <span>AB</span>
                                                                </div>
                                                    ...
                                                    <li class="chat-item">
                                                        <a class="chat-link" href="html/apps-chats.html">
                                                            <div class="chat-media user-avatar">
                                                                <img src="{{asset('public/admin/assets/images/avatar/a-sm.jpg')}}" alt="">
                                                                <span class="status dot dot-lg dot-success"></span>
                                                            </div>
                                                            <div class="chat-info">
                                                                <div class="chat-from">
