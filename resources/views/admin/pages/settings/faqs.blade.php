                                ...
                                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                    <thead>
                                        <tr class="nk-tb-item nk-tb-head">
                                            ...
                                            <th class="nk-tb-col"><span class="sub-text">Faq No.</span></th>
                                            ...
                                            <th class="nk-tb-col tb-col-lg"><span class="sub-text">Answer</span></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="nk-tb-item">
                                            ...
                                            <td class="nk-tb-col">
                                                <span class="tb-amount">Q-{{ $item->faq }}</span>
                                            </td>
                                            ...
                                            <td class="nk-tb-col tb-col-lg custom_des2">
                                                <span>@php echo $item->ans; @endphp</span>
                                            </td>
                                        ...
                                        <div class="modal fade" tabindex="-1" id="editModal{{ $item->id }}">
                                            <div class="modal-dialog modal-dialog-top" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ url('edit_faqs', $item->id) }}" method="post" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="row custom-banner-row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <div class="form-control-wrap">
                                                                            <input type="number" class="form-control" value="{{ $item->faq }}" id="faq" name="faq" placeholder="Faq No." >
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <div class="form-control-wrap">
                                                                            <input type="text" class="form-control" value="{{ $item->ques }}" id="ques" name="ques" placeholder="Question" >
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <div class="form-control-wrap">
                                            ...
                                            <div class="modal-dialog modal-dialog-top" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ url('/delete_faqs', $item->id) }}" method="post">
                                                            {{ csrf_field() }}
				...
				<form action="{{ route('faqs.store') }}" method="post" enctype="multipart/form-data">
					...
					<div class="row custom-banner-row">
						<div class="col-md-12">
							<div class="form-group">
								<div class="form-control-wrap">
									<input type="number" class="form-control @error('faq') is-invalid @enderror" value="{{ old('faq') }}" id="faq" name="faq" placeholder="Faq No." >
                                    @error('faq')
							...
							<div class="form-group">
								<div class="form-control-wrap">
									<input type="text" class="form-control @error('ques') is-invalid @enderror" value="{{ old('ques') }}" id="ques" name="ques" placeholder="Question" >
                                    @error('ques')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
							...
							<div class="form-group">
								<div class="form-control-wrap">
									<textarea type="text" class="form-control" id="summary-ckeditor" name="ans" placeholder="Answer" rows="2" >{{ old('ans') }}</textarea>
									@error('ans')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
...
@section('admin-js')
	...
	@foreach (App\Faq::orderBy('id', 'asc')->get() as $faq)
		CKEDITOR.replace( 'summary-ckeditor{{ $faq->id }}' );
	@endforeach
