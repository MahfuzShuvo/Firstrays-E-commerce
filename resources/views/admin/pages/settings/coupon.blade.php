                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Coupon</h3>
                                ...
                                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                    <thead>
                                        <tr class="nk-tb-item nk-tb-head">
                                            ...
                                            <th class="nk-tb-col"><span class="sub-text">Remaining</span></th>
                                        ...
                                        <tr class="nk-tb-item">
                                           ...
                                           {{--  <td class="nk-tb-col">
                                            ...
                                            @php
                                            	...
                                            	$difference = $today->diffInDays($expiry, false)
                                            @endphp
                                           	<td class="nk-tb-col">
                                                @if (!is_null($item->expiry_date))
	                                                ...
	                                                @endif
	                                            @else
	                                            	<span class="text-primary" style="font-weight: bold;">LIFETIME</span>
                                                @endif
                                            </td>
                                            ...
                                            <td class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                    ...
                                                    @if ($item->status)
                                                        <li class="nk-tb-action-hidden">
                                                            <form action="{{ url('/coupon_status', $item->id) }}" method="post">
                                                                @csrf
                                        ...
                                        <div class="modal fade" tabindex="-1" id="editModal{{ $item->id }}">
                                            <div class="modal-dialog modal-dialog-top" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ url('edit_coupon', $item->id) }}" method="post" enctype="multipart/form-data">
															@csrf
															<div class="row custom-banner-row">
																<div class="col-md-12">
																	<div class="form-group">
																		<label class="form-label" for="default-06">Coupon Code</label>
																		<div class="form-control-wrap">
																			<input type="text" class="form-control" value="{{ $item->code }}" id="code" name="code" placeholder="Coupon code" style="text-transform:uppercase">
																		</div>
																	</div>
																	<div class="form-group">
																	...
																	<div class="form-group">
										                                <div class="form-control-wrap">
										                                    ...
										                                    <input type="number" class="form-control" value="{{ $item->amount }}" id="amount2" name="amount" placeholder="">
										                                </div>
										                            </div>
										                            <div class="form-group">
										                                ...
										                                <div class="form-control-wrap">
										                                    ...
										                                    <input type="text" class="form-control date-picker" data-date-format="yyyy-mm-dd" name="expiry_date" placeholder="yyyy-mm-dd" value="{{ $item->expiry_date }}">
										                                </div>
										                            </div>
																</div>
															</div>
					...
					<div class="row custom-banner-row">
						<div class="col-md-12">
							<div class="form-group">
								<label class="form-label" for="default-06">Coupon Code</label>
								<div class="form-control-wrap">
									<input type="text" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" id="code" name="code" placeholder="Coupon code" style="text-transform:uppercase">
                                    @error('code')
							...
							<div class="form-group">
                                <div class="form-control-wrap">
                                    <label class="form-label" for="default-06">Amount</label>
                                    <input type="number" class="form-control @error('amount') is-invalid @enderror" value="{{ old('amount') }}" id="amount" name="amount" >
                                    @error('amount')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input type="text" class="form-control date-picker" data-date-format="yyyy-mm-dd" name="expiry_date" placeholder="yyyy-mm-dd">
                                </div>
                            </div>
						</div>
					</div>
...
@section('admin-js')
		...
		$(document).ready(function() {
			$('#type').on('change keyup', function () {
				...
				if (type == "Percentage") {
					...
					document.getElementById("amount").placeholder = "BDT.";
				}
			});
		});
	</script>
	<script type="text/javascript">
		$(document).ready(function() {
			$('#type2').on('change keyup', function () {
				var type = $('#type2').val();
				if (type == "Percentage") {
					document.getElementById("amount2").placeholder = "%";
				}
				else {
					document.getElementById("amount2").placeholder = "BDT.";
				}
			});
		});
	</script>
