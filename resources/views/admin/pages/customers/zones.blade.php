...
@section('content')
                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Thana/Zone List</h3>
                                ...
                                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                    <thead>
                                        <tr class="nk-tb-item nk-tb-head">
                                            ...
                                            <th class="nk-tb-col"><span class="sub-text">Division</span></th>
                                            <th class="nk-tb-col"><span class="sub-text">District</span></th>
                                            <th class="nk-tb-col"><span class="sub-text">Thana/Zone</span></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="nk-tb-item">
                                            ...
                                            <td class="nk-tb-col">
                                                <span class="tb-amount">{{ $item->district->division->name }}</span>
                                            </td>
                                            <td class="nk-tb-col">
                                                <span class="tb-amount">{{ $item->district->name }}</span>
                                            </td>
                                            <td class="nk-tb-col">
                                        ...
                                        {{-- <div class="modal fade" tabindex="-1" id="editModal{{ $item->id }}">
                                            <div class="modal-dialog modal-dialog-top" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ url('edit_brand', $item->id) }}" method="post" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="row custom-banner-row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <div class="form-control-wrap">
                                                                            <input type="text" class="form-control" value="{{ $item->name }}" id="name" name="name" placeholder="Brand Name" >
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <div class="form-control-wrap">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <img src="{{ $item->image }}" alt="image" width="100" style="margin-bottom: 1.25rem; border-radius: 3px; display: block;">
                                                                        <div class="form-control-wrap">
                                            ...
                                            <div class="modal-dialog modal-dialog-top" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ url('/delete_zone', $item->id) }}" method="post">
                                                            {{ csrf_field() }}
	...
	<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
	                <h5 class="modal-title">Add Thana/Zone</h5>
	            </div>
				<form action="{{ route('zone.store') }}" method="post" enctype="multipart/form-data">
					...
					<div class="row custom-banner-row">
						<div class="col-md-12">
							<div class="form-group">
								<div class="form-control-wrap">
									<input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" id="name" name="name" placeholder="Thana/Zone Name" >
                                    @error('name')
							...
							<div class="form-group">
								<label class="form-label" for="default-06">District</label>
								<div class="form-control-wrap">
									<select class="form-control @error('district_id') is-invalid @enderror" name="district_id">
				                        ...
				                        @foreach (App\Division::orderBy('id', 'asc')->get() as $division)
				                        <option disabled style="color: #c7c7c7;">- {{$division->name}}</option>
				                        	@foreach (App\District::orderBy('id', 'asc')->where('division_id', $division->id)->get() as $district)
                                    ...
                                    @error('district_id')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>Select district first</strong>
                                        </span>
                                    @enderror
								</div>
							</div>
