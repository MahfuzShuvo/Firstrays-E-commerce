                                        ...
                                        <tr class="nk-tb-item">
                                            ...
                                            <td class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                    ...
                                                    @if ($item->status)
                                                        <li class="nk-tb-action-hidden">
                                                            <form action="{{ url('/division_status', $item->id) }}" method="post">
                                                                @csrf
                                            ...
                                            <div class="modal-dialog modal-dialog-top" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ url('/delete_division', $item->id) }}" method="post">
                                                            {{ csrf_field() }}
				...
				<form action="{{ route('division.store') }}" method="post" enctype="multipart/form-data">
					...
					<div class="row custom-banner-row">
						<div class="col-md-12">
							<div class="form-group">
								<div class="form-control-wrap">
									<input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" id="name" name="name" placeholder="Division Name" >
                                    @error('name')
