                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">District List</h3>
                                ...
                                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="nk-tb-item">
                                            ...
                                            <td class="nk-tb-col">
                                                <span class="tb-amount">{{ $item->division->name }}</span>
                                            </td>
                                            <td class="nk-tb-col">
                                            ...
                                            <div class="modal-dialog modal-dialog-top" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ url('/delete_district', $item->id) }}" method="post">
                                                            {{ csrf_field() }}
				...
				<form action="{{ route('district.store') }}" method="post" enctype="multipart/form-data">
					...
					<div class="row custom-banner-row">
						<div class="col-md-12">
							<div class="form-group">
								<div class="form-control-wrap">
									<input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" id="name" name="name" placeholder="District Name" >
                                    @error('name')
							...
							<div class="form-group">
								<label class="form-label" for="default-06">Division</label>
								<div class="form-control-wrap">
                                    ...
                                    @error('division_id')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>Select division first</strong>
                                        </span>
                                    @enderror
								</div>
							</div>
