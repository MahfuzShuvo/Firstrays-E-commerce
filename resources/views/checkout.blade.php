					...
					<form class="needs-validation" novalidate>
						...
						<div class="row">
							...
							<div class="col-md-4 mb-3">
								...
								<select class="custom-select d-block w-100" id="division_id" required>
							...
							<div class="col-md-4 mb-3">
								...
								<select class="custom-select d-block w-100" id="district_id" required>
							...
							<div class="col-md-4 mb-3">
								...
								<select class="custom-select d-block w-100" id="zone_id" required>
						...
						<div class="d-block my-3">
							<div class="custom-control custom-radio">
								...
								<label class="custom-control-label custom-label" for="credit">Credit card</label>
							</div>
							<div class="custom-control custom-radio">
